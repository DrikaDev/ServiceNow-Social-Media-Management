...
- ✅ 3 variables obrigatórias (com indicação de *asterisco vermelho*)
...
- ✅ Restrição de acesso apenas para os grupos:
...
### 📌 Observação
Não foi necessário associar o Record Producer a um catálogo ou categoria.
